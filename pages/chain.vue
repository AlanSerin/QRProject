  ...
  <div class="container">
    <div class="card-container">
      <div class="left-side">
              ...
              <b-modal v-if="modalActive" size="xl" class="maps-modal h-100" ref="details" hide-footer hide-header no-close-on-esc hide-header-close no-close-on-backdrop :id="validateChain ? 'details' : 'card'">
...
export default {
  ...
  methods: {
    ...
    validationFormIFrame() {
      console.log('hello1')
      return new Promise((resolve, reject) => {
        this.$refs.iFrameDetails.validate().then(success => {
          if (success) {
            console.log('Im here')
            resolve(true)
          } else {
