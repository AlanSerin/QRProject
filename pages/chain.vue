    ...
    <div class="left-side">
      ...
      <b-modal size="xl" class="maps-modal h-100" id="chainModal" hide-footer hide-header  static @hidden="resetModal">
        ...
        <form-wizard ref="myWizard" color="#66d466" :title="null" :subtitle="null" :startIndex="0" finish-button-text="Tamamla" next-button-text="Ileri" back-button-text="Geri" class="chain-form" @on-complete="formSubmitted" style="min-height: 42.5rem;">
          ...
          <tab-content title="Ödeme Bilgileri" icon="fas fa-credit-card" :before-change="()=>validateForm('cardDetails')" :after-change="sendChain">
            <div>
              ...
              <validation-observer ref="cardDetails" tag="form">
                ...
                <b-row class="mb-4">
                  <b-col order="2" order-md="1" md="6">
                    <b-row>
                      ...
                      <b-col md="6">
                        <b-form-group label="Kart Numarasi" label-for="i-card">
                          <validation-provider #default="{ errors }" rules="required|credit-card">
                    ...
                    <b-row>
                      <b-col md="6">
                        <b-form-group label="Son Kullanma " label-for="i-expiration">
                          <validation-provider #default="{ errors }"  rules="required">
                      ...
                      <b-col md="6">
                        <b-form-group label="CVV Kodu" label-for="i-cvv">
                          <validation-provider #default="{ errors }" name="CVV" rules="required|min:3">
                            <b-form-input id="i-cvv" v-model="cardDetails.cvv" name="CardCvv" :formatter="cvvFormatter" :state="errors.length > 0 ? false:null" placeholder="212" />
                            <small class="text-danger">{{ errors[0] }}</small>
                          </validation-provider>
                        </b-form-group>
                      </b-col>
                  ...
                  <b-col order="1" order-md="2" md="6">
                    <div class="p-4 m-4">
                      <LazyCreditCard :name="cardDetails.name"  :number="cardDetails.cardNumber" :exp="cardDetails.expiration" :ccv="cardDetails.cvv" />
                    </div>
                  </b-col>
                </b-row>
          ...
          <template slot="footer" slot-scope="props">
            ...
            <div class="wizard-footer-right">
              ...
              <wizard-button v-if="props.isLastStep" @click.native="odemeYap" class="wizard-footer-right" :style="props.fillButtonStyle" >Ödeme Yap - 100,00 TL</wizard-button>
            </div>
          </template>
        </form-wizard>
...
export default {
  ...
  data() {
    return {
      ...
      cardDetails: {
        name: 'Taner Sancar',
        cardNumber: '5487-9319-7412-1516',
        cvv: '334',
        expiration: '09/27',
      },
      chainNumber: 0,
      chains: [],
      chainDetails: {
        latitude: '35.19891803767585',
        longitude: '33.4058211855469',
        address: 'Uludağ Apt.',
        province: '60b694ad1ef1d64168a63173',
        district: '60b695361ef1d64168a63179',
        phone: '542 874 6061',
        personnelName: 'Taner SANCAR',
        // main: false,
      },
      loadingWizard:false,
      resp:{}
